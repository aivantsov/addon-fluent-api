 ...
 * @since 1.1.0
 */
public class FluentApiMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = FluentApiMetadata.class.getName();
    ...
    public FluentApiMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
